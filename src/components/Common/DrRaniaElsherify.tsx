        ...
        <div className="row g-4 mt-lg-5">
          <div className="col-xl-7 col-md-12">
            <div className="doctors-overview-content ">
              ...
              <p className="profile-text">Obstetrics & Gynecology Registrar </p>
              ...
              <p className="profile-text-last">
                ...
                <span className="lang-box">German </span>
              </p>

              <p>
                Dr. Rania Elsherify is a highly experienced Obstetrics & Gynecology Registrar at
                Bnoon – Al Ahsa (located inside Almoosa Specialist Hospital) with an extensive
                background in reproductive medicine, infertility management, and women’s health.
                With nearly three decades of clinical expertise, she brings rich academic
                credentials and hands-on experience in managing complex fertility cases and offering
                individualized gynecological care.
              </p>
              <p>
                Dr. Rania graduated with a Bachelor of Medicine from Ain Shams University in Cairo
                in 1995, followed by a Master’s degree in Obstetrics and Gynecology in 2000. She
                later earned her PhD in Environmental Medical Sciences from Ain Shams University in
                2014. In 2023, she completed a Professional Diploma in Reproductive Medicine and
                Surgery at Birmingham Women’s Hospital in the United Kingdom, further advancing her
                specialization in assisted reproduction.
              </p>
              <p>
                Before joining Bnoon – Al Ahsa, she worked at Almoosa Specialist Hospital; and
                served as an IVF Consultant and later as Medical Director of the East Cairo branch
                of Adam{' '}
              </p>
            </div>
          </div>
          ...
          <div className="col-xl-12 col-md-12">
            <div className="doctor-overview-content ">
              <p>
                International Hospital for Fertility, where she oversaw clinical operations and
                helped shape fertility treatment pathways for thousands of patients. Her clinical
                expertise spans evaluation and management of primary and secondary infertility,
                ultrasound assessment of ovarian and uterine health, controlled ovarian stimulation,
                and the diagnosis and treatment of vaginismus.{' '}
              </p>
              <p>
                Dr. Rania is deeply committed to providing compassionate, evidence-based care and
                supporting women and couples through every step of their fertility and reproductive
                health journey.
              </p>
            </div>
          </div>
