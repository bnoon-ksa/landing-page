          ...
          <div className="row justify-content-center align-items-center g-4">
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                <p>
                  WA'AD Bnoon Program is a first-of-its-kind initiative in Saudi Arabia designed to
                  support hopeful parents emotionally, medically, and financially to begin their
                  fertility journey with confidence - giving them peace of mind and a clear path
                  forward. 
                </p>

                <p>
                  We’re committed to walking with you every step of the way; and if a pregnancy was
                  not achieved after three IVF cycles within one year, we will refund the cost of
                  your third treatment cycle. That’s our promise to you.
                </p>
