        ...
        <div className="row g-4 mt-lg-5">
          <div className="col-xl-7 col-md-12">
            <div className="doctors-overview-content">
              ...
              <p>
                Dr. Ahmed Ali Al-Nowasser is a highly experienced Obstetrics, Gynecology &
                Reproductive Medicine & Infertility (IVF) Consultant at Bnoon – Al Ahsa (located
                inside Almoosa Specialist Hospital) with more than seventeen years of clinical,
                surgical, and academic expertise across leading maternity and referral hospitals in
                Saudi Arabia.{' '}
              </p>{' '}
              <p>
                Dr. Ahmed possesses advanced skillset in infertility management, IVF/ICSI, minimally
                invasive gynecologic surgery, and high-risk obstetrics. He has completed his MBBS at
                Damascus University in 2008 and earned both the Saudi Board and the Arab Board in
                Obstetrics & Gynecology in 2014. He went on to pursue a distinguished pathway of
                international specialization, including a Diploma and Fellowship in Minimal Access
                Surgery in 2015 (India), a Diploma in Reproductive Medicine & Embryology (Germany),
                a Fellowship in Assisted Reproductive Technology in 2017 (India), and most recently,
                a Fellowship in Reproductive Medicine from IVI Clinic, Spain and an MD in
                Reproductive Medicine from IVI and the University of Valencia in Spain.{' '}
              </p>
            </div>
          </div>
          ...
          <div className="col-xl-12 col-md-12">
            <div className="doctor-overview-content ">
              <p>
                Across his career at the Maternity & Children Hospital (MCH) in Al-Ahsa, he has led
                reproductive medicine services, advanced laparoscopic and hysteroscopic procedures,
                and trained residents within the Saudi Board OB/GYN program. He also currently
                practices at the Obstetrics & Gynecology Department at Almoosa Specialist Hospital
                and has previously served as Consultant at MCH Najran. Dr. Ahmed continues to
                contribute to national CME initiatives, medical education, and outreach programs
                supporting women’s health across the Kingdom.
              </p>
            </div>
          </div>
        </div>
