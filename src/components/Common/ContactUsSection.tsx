          ...
          <div className="row justify-content-center align-items-center g-4">
            <div className="col-lg-12 col-md-12">
              ...
              <div className="left text-center mt-2">
                <p>
                  At Bnoon, we understand that the path to parenthood is deeply personal — and often
                  filled with questions. Whether you’re facing challenges with male or female
                  infertility, seeking support for gynecological conditions, or planning for a
                  healthy pregnancy, we are here to guide you with compassion, expertise, and care.{' '}
                  <br />
                  <br />
                  Our multidisciplinary team provides comprehensive, evidence-based treatments
                  tailored to your needs — from advanced fertility solutions and hormone health to
                  obstetric and gynecological care. Wherever you are in your journey, Bnoon is here
        ...
        <div className="row justify-content-center text-center g-4">
          ...
          >
            <div className="p-4 contact-border h-100">
              ...
              <p>
                Please fill out the Request an Appointment form and one of our patient coordinators
                will contact you within 48 hours to confirm your appointment and answer any initial
                questions.
              </p>
            </div>
          </div>
        ...
        <div className="section-title mt-5">
          <div className="row justify-content-center align-items-center g-4">
            <div className="col-lg-12 col-md-12">
              ...
              <div className="left text-center mt-2">
                <p>
                  Bnoon has leading fertility centers across Saudi Arabia, designed with your
                  comfort, privacy, and outcomes in mind.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row text-center g-4">
          ...
          <div className="col-lg-6 col-md-8">
            <div className="p-0 p-lg-4 location-border h-100">
              <h5 className="mb-3">
                <strong>Bnoon - Riyadh</strong>
              </h5>
              <p>
                Abi Jafar Bin Mansur Street, <br />
                Al-Shuhada, 13241 Riyadh, Saudi Arabia
                <br />
                +966 11 444 8080
              </p>
          ...
          <div className="col-lg-6 col-md-8">
            <div className="p-0 p-lg-4 location-border h-100 text-center">
              <h5 className="mb-3">
                <strong>Bnoon - Jeddah</strong>
              </h5>
              <p className="text-left">
                3340 Quartz Building, Al Cornishe Road, Al Shatea,
                <br /> Jeddah 23412, Saudi Arabia
                <br />
                +966 12 680 0800
              </p>
          ...
          <div className="col-lg-6 col-md-8">
            <div className="p-0 p-lg-4 location-border h-100 text-center">
              <h5 className="mb-3">
                <strong>Bnoon – Al Ahsa </strong>
              </h5>
              <p className="text-left">
                South Tower, Floor 12, <br />
                Almoosa Specialist Hospital Dharan Road,
                <br /> Al Mubarraz 36342
              </p>
          ...
          <div className="section-title border-top">
            <div className="row justify-content-center align-items-center g-4">
              <div className="col-lg-12 col-md-12">
                ...
                <div className="left text-center mt-2">
                  <p>
                    At Bnoon, your feedback matters. We are committed to delivering the highest
                    standards of care, and your feedback helps us grow, improve, and serve you
                    better. Whether it's a suggestion, a story, or a simple rating — thank you for
                    taking a moment to share your thoughts with us.
                  </p>
                </div>
                <div className="mt-4">
