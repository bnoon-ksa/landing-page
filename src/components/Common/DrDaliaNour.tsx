          ...
          <div className="col-xl-7 col-md-12">
            <div className="doctors-overview-content">
              ...
              <p className="profile-text">
                Consultant, Obstetrics, Gynecology & Delayed Pregnancy{' '}
              </p>
              ...
              <p>
                Dr. Dalia Nour is a Consultant in Obstetrics, Gynecology, and Infertility treatment
                at Bnoon – Riyadh since 2022. With a distinguished clinical and academic career
                across Saudi Arabia and Egypt, she also currently serves as an Assistant Professor
                at Cairo University, Egypt.{' '}
              </p>
              <p>
                She earned her Bachelor of Medicine and Surgery (MBBCh) from Cairo University in
                2007, graduating with honors. She completed her internship at Cairo University
                Hospitals in 2008, followed by a three-year residency in Obstetrics and Gynecology
                at Kasr Al-Ainy, Cairo University. In 2012, she obtained her Master’s degree in
                Obstetrics and Gynecology and joined the university’s faculty as a Demonstrator. In
                2018, she was awarded her Doctorate (MD/PhD), and in July 2025, she was promoted to
                Assistant Professor.{' '}
              </p>

              <p>
                Since 2018, Dr. Dalia has specialized in in vitro fertilization (IVF) and
                infertility treatment, working across Cairo University Hospitals and leading
                fertility centers in Egypt. She has been an active faculty member in the IVF Diploma
                at Cairo University and has participated in numerous IVF-focused workshops.
                <br />
                She holds the American Diploma in Women’s Cosmetic Procedures and is certified in
                both diagnostic and operative hysteroscopy. Dr. Dalia has also completed Part 1 of
                the Membership of the Royal College of Obstetricians and Gynecologists (MRCOG), UK.
                <br />
                Her clinical approach combines academic excellence with patient-centered care,
                particularly in advanced fertility, gynecological surgery, and women's health.{' '}
              </p>
            </div>
          </div>
