        ...
        <div className="row g-4 mt-lg-5">
          <div className="col-xl-7 col-md-12">
            <div className="doctors-overview-content">
              ...
              <p>
                Dr. Ahmed Baker Alshaik is a distinguished Consultant in Reproductive Endocrinology
                & Infertility (REI) and Assisted Reproductive Technique (ART, IVF) at Bnoon -
                Jeddah. Previously, he served as an Assistant Professor in the Obstetrics and
                Gynecology department at Jouf University, where he organized courses for medical
                students in the 4th, 5th, and 6th years. Dr Alshaik also held the position of
                Consultant in Obstetrics and Gynecology at the Maternity and Children Hospital,
                specializing in Infertility Gyne/Endocrinology and Fertility Preservation.{' '}
              </p>
              <p>
                He completed his fellowship training program in Reproductive Endocrinology and
                Infertility at Karolinska University Hospital/Stockholm IVF under the mentorship of
                Prof. Mats Brännström. Dr. Alshaik holds a PhD degree for his research on the
                development of bioengineered ovaries for safe fertility preservation in female
                leukemia patients, focusing on basic studies in animal models.{' '}
              </p>
            </div>
          </div>
          ...
          <div className="col-xl-12 col-md-12">
            <div className="doctor-overview-content">
              <p>
                Dr. Alshaik's expertise spans reproductive endocrinology and infertility, where he
                specializes in advanced Assisted Reproductive Techniques (ART) such as In Vitro
                Fertilization (IVF). His clinical practice includes managing complex cases of
                infertility, reproductive disorders, and fertility preservation strategies. Dr.
                Alshaik is renowned for his research contributions in bioengineering ovaries and his
                dedication to advancing reproductive medicine through innovative techniques.{' '}
              </p>
              <p>
                Dr. Ahmed Baker Alshaik has been recognized for his outstanding contributions to
                Reproductive Endocrinology and Infertility. His PhD research under the supervision
                of Prof. Mats Brännström has been pivotal in the field of fertility preservation. He
                has presented his research findings at numerous national and international
                conferences, including publications in esteemed scientific journals. Dr. Alshaik's
                commitment to patient care, education, and research exemplifies his leadership in
