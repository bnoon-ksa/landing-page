          ...
          <div className="d-flex align-items-center">
            <Link href="/en" className="navbar-brand d-flex align-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 183 76" width={183} height={75} aria-label="Bnoon">
                <path fill="#39bced" d="m137.17 7.27c-12.45 0-22.54 10.1-22.54 22.56 0 12.46 10.09 22.56 22.54 22.56 12.44 0 22.53-10.1 22.53-22.56 0-12.46-10.09-22.56-22.53-22.56zm0 32.04c-5.23 0-9.47-4.24-9.47-9.48 0-5.24 4.24-9.48 9.47-9.48 5.23 0 9.47 4.24 9.47 9.48 0 5.24-4.24 9.48-9.47 9.48zm28.63 29.54c-5.23 0-9.47-4.24-9.47-9.48 0-5.24 4.24-9.48 9.47-9.48 5.23 0 9.48 4.24 9.48 9.48 0 5.24-4.25 9.48-9.48 9.48z"/>
                <g fill="#ffffff">
