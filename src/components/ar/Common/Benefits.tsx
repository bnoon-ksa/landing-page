...
const Benefits = () => {
  const benefitsData = [
    {
      id: 1,
      icon: "https://bnoon.blob.core.windows.net/website/images/icons/benefit1.svg",
      title: "Convenient & Fast",
      description: "See a doctor within minutes—no waiting rooms.",
    },
    {
      id: 2,
      icon: "https://bnoon.blob.core.windows.net/website/images/icons/benefit2.svg",
      title: "Certified Doctors",
      description: "Licensed professionals in multiple specialties.",
    },
    {
      id: 3,
      icon: "https://bnoon.blob.core.windows.net/website/images/icons/benefit3.svg",
