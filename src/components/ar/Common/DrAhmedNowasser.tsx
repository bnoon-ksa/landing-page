        ...
        <div className="row g-4 mt-lg-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p>
                يعمل الدكتور أحمد علي النويصر كاستشاري أمراض النساء والولادة والعقم وأطفال الأنابيب
                والمناظير في بنون – الأحساء ويعدّ من الكفاءات الطبية البارزة بخبرة تتجاوز سبعة عشر
                عاماً في رعاية صحة المرأة، وتقنيات الإخصاب المساعد ومتابعة الحمل عالي الخطورة،
                وجراحات المناظير النسائية.{' '}
              </p>

              <p>
                صل الدكتور أحمد على درجة البكالوريوس في الطب والجراحة من جامعة دمشق عام 2008، ثم نال
                الدبلوم المهني في إدارة المستشفيات من جامعة عين شمس عام 2014. ويحمل كلاً من البورد
                العربي والبورد السعودي في أمراض النساء والولادة منذ عام 2014، مما يعكس تأهيله الراسخ
                في هذا التخصص. كما أتمّ زمالة الجراحات طفيفة التوغل (المناظير) عام 2015، ثم زمالة
                تقنيات الإخصاب المساعد عام 2019 في الهند وأكمل زمالة في الطب التناسلي وأطفال
                الأنابيب من مركز IVI في إسبانيا وشهادة الطب في الطب الإنجابي من جامعة فالانسيا في
                إسبانيا، ما رسخ خبرته في مجال علاج العقم والطب التناسلي.{' '}
              </p>
              <p>
                على مدى مسيرته المهنية، عمل الدكتور النواصر استشارياً للنساء والولادة في مستشفى
                الولادة والأطفال بالأحساء منذ عام 2009، وأسهم في تطوير خدمات الأمومة وصحة المرأة،
                وإدارة العديد من الحالات الدقيقة والمعقدة وفي مستشفى الولادة والأطفال بنجران كما
                يعمل حالياً في ضمن عيادة أمراض النساء والولادة في مستشفى الموسى التخصصي.
              </p>
              <p>
                يواصل الدكتور أحمد مساهماته في برامج التعليم الطبي المستمر، وتدريب الكوادر الطبية
                وتقديم رعاية شاملة ومتكاملة للنساء في مختلف مراحل حياتهن والمشاركة في المبادرات
                التوعوية الداعمة لصحة المرأة في مختلف مناطق المملكة.
              </p>
            </div>
          </div>
