          ...
          <div className="row justify-content-center align-items-center g-4">
            ...
            <div className="left">
              <p className="text-center">
               نشكركم على ثقتكم بنا وتحويل المريض لغرض الخصوبة. الرجاء تعبئة النموذج أدناه، وسيقوم أحد أعضاء فريقنا بالتواصل مع المريض خلال فترة وجيزة لتقديم المساعدة وحجز الموعد المطلوب.
              </p>
            </div>
          </div>
        </div>
