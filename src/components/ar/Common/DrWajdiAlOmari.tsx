        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p className="profile-text">استشاري، الإخصاب وتأخر الحمل </p>
              ...
              <p>
                الدكتور وجدي العمري هو استشاري أمراض النساء والولادة والغدد التناسلية والإخصاب في
                بنون – الرياض، ويتمتع بخبرة سريرية وأكاديمية تزيد عن 19 عاماً. ويُعرف بدوره الريادي
                في رعاية الخصوبة وصحة المرأة في المملكة العربية السعودية۔
              </p>
              <p>
                من جامعة أم  (MBBS)  حصل الدكتور وجدي على درجة البكالوريوس في الطب والجراحة القرى في
                مكة المكرمة عام 2005، وأكمل شهادة البورد السعودي في أمراض النساء والولادة عام 2014.
                واصل دراسته التخصصية في فرنسا، حيث نال الزمالة في مجال الغدد التناسلية والعقم وأطفال
                الأنابيب من مستشفى جامعة مونبيلييه–نيم (2015 – 2017)۔
              </p>

              <p>
                شغل الدكتور وجدي سابقاً منصب استشاري في مدينة الملك سعود الطبية بالرياض، وتولى عدة
                مناصب قيادية، منها: مدير برنامج الإقامة في قسم النساء والتوليد، ورئيس وحدة الإخصاب
                وأطفال الأنابيب. كما عمل بين عامي 2014 و2019 كأستاذ مساعد في جامعة المجمعة، وشغل
                خلالها منصب نائب رئيس قسم النساء والتوليد۔
              </p>
              <p>
                للدكتور وجدي خبرة واسعة في القطاعين الحكومي والخاص، وقد ساهم في العديد من الأبحاث في
                مجال الخصوبة، وشارك كمتحدث في مؤتمرات طبية على مستوى المملكة۔ ويشارك ،(ALSO) كما
                يحمل اعتماداً كمدرب في دورة دعم الحياة المتقدم في التوليد بفاعلية في التدريب الطبي
                والتطوير المهني للأطباء۔{' '}
              </p>
            </div>
          </div>
