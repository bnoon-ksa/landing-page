        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p>
                الدكتورة رزان غيث هي استشارية في طب النساء والتوليد والعقم في بنون بمدينة جدة منذ
                عام 2021. عملت الدكتورة رزان في العديد من المؤسسات الطبية داخل المملكة من جامعة
                الملك  (M.D)  العربية السعودية وخارجها. وقد حصلت على درجة الطب عبدالعزيز عام 2009،
                وأكملت برنامج الإقامة في طب النساء والتوليد بمستشفى الحرس الوطني في جدة، ثم تابعت
                دراساتها العليا لتحصل على درجة الماجستير في علم الأجنة السريري من جامعة موناش في
                ملبورن، أستراليا۔ ​{' '}
              </p>{' '}
              <p>
                تتخصص الدكتورة رزان في إدارة حالات تأخر الإنجاب، وتشرف على الرعاية العامة للنساء
                والتوليد بما يشمل رعاية ما قبل الولادة والولادات والإجراءات الجراحية۔
              </p>{' '}
              <p>
                تلتزم الدكتورة غيث بالتعامل مع احتياجات واهتمامات كل زوجين بشكل فردي، وهدفها هو
                تقديم خيارات علاجية شاملة ومساعدة الأزواج على تحقيق أفضل النتائج الممكنة۔{' '}
              </p>
            </div>
          </div>
