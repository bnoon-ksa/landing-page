    ...
    <div className="service-overview-area mb-5 mt-3 mt-lg-5">
      <div className="container">
        ...
        <div className="row justify-content-center align-items-center g-4">
          <div className="col-xl-6 col-md-12">
            ...
            >
              ...
              <p>
                يقدّم المركز باقة شاملة من خدمات الخصوبة، تشمل: أطفال الأنابيب الحقن المجهري التلقيح
                الصناعي تجميد البويضات والحيوانات المنوية، بالإضافة إلى تحاليل هرمونية دقيقة،
                تقييمات لحالات الإجهاض المتكرر، وعلاجات تخصصية للرجال، مع خطط علاجية بما يتناسب مع
                كل حالة۔
              </p>
              <p>
        ...
        <div
          ...
          className="row justify-content-center align-items-center g-4 flex-column-reverse flex-md-row mt-5"
        >
          ...
          <div className="col-xl-6 col-md-12">
            ...
            >
              ...
              <p>
                وستُدار كل خطوة في رحلة العلاج — من الاستشارات الرقمية وحتى تتبّع دورات العلاج
                لحظياً — عبر تقنيات الصحة الذكية والمنصات الرقمية المتكاملة، لضمان أعلى مستويات
                الدقة والكفاءة والتخصيص۔
              </p>
              <p>
