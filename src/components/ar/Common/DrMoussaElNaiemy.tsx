        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p className="profile-text">استشاري أمراض الذكورة والعقم </p>
              ...
              <p>
                يُعد الدكتور موسى النعيمي من الأطباء البارزين في مجال جراحة المسالك البولية وأمراض
                الذكورة والعقم لدى الرجال، ويتمتع بخبرة سريرية وأكاديمية تمتد لأكثر من ثلاثة عقود في
                المملكة العربية السعودية وأمريكا الشمالية. قبل انضمامه إلى مركز بنون في الرياض، عمل
                كاستشاري في أمراض المسالك البولية والذكورة والعقم لدى الرجال في مستشفى القوات
                المسلحة بالرياض منذ عام 2010. ويُعرف بخبرته الواسعة في صحة الرجل الإنجابية، ضعف
                الانتصاب، مرض بيروني، وتقنيات استخراج الحيوانات المنوية المتقدمة۔
              </p>
              <p>
                تخرج الدكتور النعيمي من جامعة الملك سعود (بكالوريوس الطب والجراحة)، وحصل على شهادة
                الاختصاص السعودي في جراحة المسالك البولية عام 2003، وأكمل زمالة متميزة في أمراض
                الذكورة والمسالك البولية في جامعة ويسترن أونتاريو في كندا بين عامي 2006 و2008. ويحمل
                أيضا@ البورد السعودي في المسالك البولية منذ عام 2004. شغل عدة مناصب قيادية في مؤسسات
                طبية متعددة، وكان له دور محوري في إدخال بروتوكولات حديثة مثل الموجات الصوتية دوبلر
                عالية الدقة لتشخيص ضعف الانتصاب، وتحديث معايير تحليل السائل المنوي بما يتماشى مع
                معايير منظمة الصحة العالمية۔
              </p>
              <p>
                يُعد الدكتور النعيمي مساهماً نشطاً في المجال الأكاديمي، حيث قدم أكثر من 30 بحثاً في
                ،(AUA) مؤتمرات علمية محلية ودولية، بما في ذلك الجمعية الأمريكية لجراحة المسالك
                البولية ،(ESSM) والجمعية الأوروبية للطب الجنسي ،(ESHRE) والجمعية الأوروبية لطب
                الإنجاب وعلم الأجنة ۔ كما نُشرت أبحاثه في مجلات مرموقة مثل(MEFS) وجمعية الشرق الأوسط
                للخصوبة ۔European Urology  وUrology Annals وBasic and Clinical Andrology
              </p>
              <p>
                ويشارك الدكتور النعيمي بانتظام في المحاضرات والندوات والمؤتمرات كمتحدث ورئيس جلسات،
                ويركز في أبحاثه على تحسين نتائج علاج العقم لدى الرجال والطب الجنسي، مما جعله شخصية
                مرجعية في تطوير الممارسة الطبية في هذا المجال في المنطقة۔{' '}
              </p>
            </div>
          </div>
