          ...
          <div className="row justify-content-center align-items-center g-4">
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                <p>
                  وعد بنون (الحمل أو استرداد الرسوم)برنامج هو مبادرة فريدة من نوعها تهدف إلى دعم
                  الأزواج الراغبين بالإنجاب من الناحية النفسية والطبية والمالية لبدء علاجات الإخصاب
                  بثقة ووضوح مما يمنحهم راحة البال وخطة علاجية واضحة۔
                </p>

                <p>
                  نلتزم بأن نكون معكم في كل خطوة — وإذا لم يتحقق الحمل بعد ثلاث محاولات لعمليات
                  أطفال الأنابيب، سنقوم برد رسوم المحاولة الثالثة. هذا هو وعدنا لكم۔
                </p>
