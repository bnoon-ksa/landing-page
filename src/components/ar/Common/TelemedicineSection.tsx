          ...
          <div className="row justify-content-center align-items-center g-4">
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                >
                  في بنون، نؤمن بأن رعاية الخصوبة تحتاج إلى سرعة في الاستجابة ووضوح ووصول مباشر إلى
                  أطباء موثوقين. لذلك تتيح لكم خدمة الاستشارات الطبية عن بُعد لدينا التواصل مع أطباء
                  بنون المتخصصين، مع الحفاظ على نفس مستوى الخبرة، والخصوصية الذي نقدمه داخل
                  عياداتنا.{' '}
                </motion.p>
                <motion.p
                  initial="hidden"
                  ...
                  variants={slideInRight}
                >
                  صُممت الاستشارات الافتراضية لدعم رحلتكم العلاجية عندما لا تكون زيارة العيادة
                  ضرورية، ومساعدتكم على الاستمرار في خططكم العلاجية دون تأخير. سواء كنتم في حاجة إلى
                  استشارة أولية ، أو تودون مراجعة نتائج الفحوصات، أو تخططون لإجراء الحقن المجهري، أو
                  تحتاجون إلى رأي طبي آخر، تضمن لكم منصتنا الافتراضية استمرارية الرعاية بسلاسة.{' '}
                </motion.p>
              </div>
            </div>
            ...
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                <ul className="values-list mt-3">
                  {values.map((value, index) => (
                    <li key={index} className="d-flex align-items-center mb-2">
                      {/* Icon */}
                      <OptimizedImage imageName="bnoon-symbol" className="me-2  icon" alt="icon" />
                      {value}
                    </li>
                  ))}
                </ul>
                <motion.p
                  ...
                  variants={slideInRight}
                >
                  لا تُعد الاستشارات عن بُعد بديلاً للحالات الطارئة أو الحالات عالية الخطورة أو
                  لإجراء العلاج، وقد يوصي الطبيب بزيارة حضورية متى ما استدعت الحالة ذلك.{' '}
                </motion.p>
              </div>
            </div>
            ...
            <div className="col-lg-12 col-md-12">
              <div className="left">
                <h2 className="mb-2 telemedicine-title">
                  لماذا يختار المرضى الاستشارات عن بُعد في بنون؟{' '}
                </h2>
                <ul className="values-list mt-3">
            ...
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                <motion.p
                  ...
                  variants={slideInRight}
                >
                  يمكنك التواصل مع مركز الاتصال لدينا على الرقم 920010022 أو تعبئة نموذج طلب الموعد
                  عبر الموقع الإلكتروني، وسيقوم فريقنا بالتواصل معك لتأكيد الموعد وشرح الخطوات
                  التالية.{' '}
                </motion.p>
              </div>
            </div>
            ...
            <div className="col-lg-12 col-md-12">
              <div className="left">
                ...
                <motion.p
                  ...
                  variants={slideInRight}
                >
                  في بنون، تبقى رعاية الخصوبة قريبة منك دائماً — أينما كنت.{' '}
                </motion.p>
              </div>
            </div>
          </div>
