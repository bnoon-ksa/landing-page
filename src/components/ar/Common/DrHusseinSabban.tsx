        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p className="profile-text">استشاري أمراض النساء والولادة والإخصاب وتأخر الحمل </p>
              ...
              <p className="profile-text-last">
                ...
                <span className="lang-box">الفرنسية (أساسية)  </span>
              </p>

              <p>
                يُعدّ الدكتور حسين صبّان من الاستشاريين المتميزين في مجال طب النساء والولادة ومتخصص
                في الغدد الصماء التناسلية وعلاجات العقم. يتمتع بخبرة سريرية تتجاوز 17 عاماً، ويقدّم
                رعاية شاملة وإدارة حالات العقم، بالإضافة إلى رعاية الأمراض النسائية  (ART/IVF)  في
                تقنيات الإخصاب المساعد من مرحلة المراهقة وحتى سن الأمل۔
              </p>
              <p>
                حصل الدكتور صبّان على درجة البكالوريوس في الطب والجراحة من جامعة الملك عبدالعزيز
                بجدة وأكمل تدريبه المتقدم في كندا حيث نال البورد الكندي في طب النساء والتوليد 
                ،(2007/2008) إضافة إلى زمالة في الغدد الصماء التناسلية والعقم من جامعة دالهاوزي في
                كندا. كما ،(FRCSC) عام 2017۔ (ABOG) اجتاز الجزء الأول من البورد الأمريكي في طب
                النساء والتوليد
              </p>

              <p>
                تشمل خبرة الدكتور صبّان مجموعة واسعة من العلاجات المتخصصة في مجال الخصوبة،
                والإجراءات الكاملة للإخصاب المساعد، إلى جانب الرعاية الشاملة لأمراض النساء والتوليد.
                كما لديه الخبرة في تشخيص وعلاج حالات العقم المتعلقة بالنساء والرجال ضمن بيئة تراعي
                الخصوصية الثقافية وتتمحور حول المريض۔
              </p>
              <p>
                يتحدث الدكتور صبّان اللغة العربية، ويتقن اللغة الإنجليزية بطلاقة، ويمتلك إلماماً
                باللغة الفرنسية، مما يتيح له التعامل مع شرائح متنوعة من المرضى والتعاون مع الخبراء
                على المستوى العالمي۔
              </p>
            </div>
          </div>
