        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p>
                الدكتور عاصم الوهيبي استشاري في الغدد التناسلية والخصوبة وأمراض النساء والولادة في
                مركز بنون – الرياض  ويتمتع بخبرة تتجاوز عشر سنوات في هذا المجال، وقد تلقى تدريبه
                المتقدم في فرنسا، وشغل مناصب قيادية في عدد من أبرز المؤسسات الطبية في المملكة. تشمل
                مجالات خبرته حالات العقم المعقدة، الاضطرابات الهرمونية، جراحات المناظير النسائية
                وحفظ الخصوبة۔
              </p>
              <p>
                من جامعة الملك عبدالعزيز  (MBBS)  حصل على درجة البكالوريوس في الطب والجراحة (DES) 
                بجدة عام 2008، ثم أكمل دراسته التخصصية في فرنسا. نال شهادة البورد الفرنسي في أمراض
                النساء والولادة من جامعة باريس ديكارت (2010–2017)، ثم تخصّص في مجال الغدد
                (2018–2021) لمدة ثلاث سنوات في الجامعة ذاتها DESC  التناسلية والخصوبة من خلال برنامج
                كما حصل على دبلوم في الغدد التناسلية والخصوبة (2019–2021)، ودبلوم في جراحة المناظير
                النسائية من جامعة كليرمون فيران، فرنسا .(2014 – 2013)
              </p>

              <p>
                إلى جانب عمله في بنون، يشغل الدكتور عاصم أيضاً منصب أستاذ مساعد واستشاري في الغدد
                التناسلية والخصوبة بجامعة الملك سعود في الرياض. كما تولى منصب مدير برنامج الإقامة في
                أمراض النساء والولادة بين عامي 2021 و2024، وكان رئيس وحدة أطفال الأنابيب في المدينة
                الطبية الجامعية خلال عامي 2022 و2023۔
              </p>
