        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p className="profile-text">نائب أول، أمراض النساء والولادة</p>
              ...
              <p>
                الدكتورة مرام دعدوع هي طبيبة نساء وتوليد متمرسة تتمتع بخبرة إكلينيكية تزيد عن عشر
                سنوات في المملكة العربية السعودية والأردن، مع تركيز خاص على تقنيات الإخصاب المساعد.
                تعمل حالياً في بنون - جدة، حيث تختص بتقييم الخصوبة، وتخطيط برامج أطفال الأنابيب،
                وتقديم الاستشارات للمرضى، بالإضافة إلى إجراءات الإخصاب المساعد مثل سحب البويضات،ونقل
                الأجنة، والتلقيح  داخل الرحم ۔(IUI)
              </p>
              <p>
                تحمل الدكتورة مرام شهادة بكالوريوس في الطب البشري من جامعة حلب، وأتمّت برنامج
                الإقامة لمدة خمس سنوات في طب النساء والتوليد في مستشفى الأمل للأمومة بالأردن، حيث
                أشرفت على غرف الولادة والحالات الطارئة، وأجرت العمليات النسائية الروتينية والمتقدمة،
                بما في ذلك مناظير البطن والرحم والإجراءات التجميلية۔
              </p>
              <p>
                منذ عام 2022 وحاصلة على تصنيف (MRCOG) هي عضو في الكلية الملكية لأطباء  النساء تتابع
                حالياً دبلوماً متقدماً في طب  .(SCFHS) نائب أول" من الهيئة السعودية للتخصصات الصحية"
                ،وجراحة الإنجاب، وتحمل عدداً من الشهادات المتخصصة في الإخصاب المساعد، والتلقيح داخل
                الرحم بعنوان  MAR  ونقل الأجنة، وحالات الولادة الطارئة. وقد نشرت في عام 2022 دراسة
                علمية في مجلة نتائج تنظير البطن لدى النساء المصابات بالعقم الأولي مقابل الثانوي"،
                وتشارك بانتظام في مؤتمرات  إقليمية ودولية في مجال الخصوبة۔
              </p>
              <p>
                تتقن اللغة العربية والإنجليزية، تجمع بين الكفاءة الطبية والحس الثقافي ونهج يركز على
                المريضة، مما يجعلها من الأطباء الموثوقين في رعاية النساء من سن المراهقة وحتى سن
                انقطاع الطمث۔{' '}
              </p>
            </div>
          </div>
