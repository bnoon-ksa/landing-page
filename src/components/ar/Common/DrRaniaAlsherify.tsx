        ...
        <div className="row g-4 mt-lg-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p className="profile-text">أخصائية أمراض النساء والولادة</p>
              ...
              <p>
                تعمل الدكتورة رانيا الشريفي كأخصائية أمراض النساء والولادة في بنون – الأحساء (الواقع
                داخل مستشفى الموسى التخصصي) وتمتلك بخبرة تمتد لما يقارب ثلاثة عقود في مجال أمراض
                النساء والولادة وطب الإنجاب، مع تركيز خاص على علاج العقم والخصوبة ورعاية صحة المرأة.
                وتتمتع الدكتورة رانيا بخبرة علمية وعملية واسعة أهلتها لإدارة العديد من الحالات
                الدقيقة وتقديم رعاية عالية الجودة للنساء.
              </p>

              <p>
                حصلت الدكتورة رانيا على بكالوريوس الطب والجراحة من كلية الطب بجامعة عين شمس في
                القاهرة عام 1995، ثم نالت درجة الماجستير في أمراض النساء والولادة عام 2000. وفي عام
                2014، حصلت على درجة الدكتوراه في العلوم الطبية البيئية من جامعة عين شمس. كما أتمّت
                في عام 2023 الدبلوم المهني في طب وجراحة الإخصاب المساعد من مستشفى النساء في برمنغهام
                – المملكة المتحدة، مما أكسبها خبرة متقدمة في مجال تقنيات الحقن المجهري والعقم.
              </p>
              <p>
                وقبل انضمامها إلى بنون، عملت في مستشفى الموسى التخصصي، كما عملت كاستشارية للحقن
                المجهري في مستشفى آدم الدولي للخصوبة، وشغلت منصب مديرة الفرع الشرقي للمستشفى في
                القاهرة، حيث أسهمت في تطوير خدمات الخصوبة. وتشمل خبراتها تقييم حالات العقم الأولي
                والثانوي، وتقييم الرحم والمبايض عبر الأشعة التلفزيونية، ومتابعة التحريض الإباضي،
                بالإضافة إلى تشخيص وعلاج حالات التشنج المهبلي.
              </p>
              <p>
                وتؤمن الدكتورة رانيا بأهمية رعاية شاملة ومبنية على الأدلة العلمية، مع الاهتمام بكل
                تفاصيل رحلة المرضى لضمان أفضل النتائج وتحسين جودة الحياة.{' '}
              </p>
            </div>
          </div>
