        ...
        <div className="row g-4 mt-5">
          <div className="col-xl-7 col-md-12">
            <div className="service-overview-content doctor-content">
              ...
              <p>
                تشغل الدكتورة داليا نور منصب استشارية في أمراض النساء والتوليد والعقم في بنون –
                الرياض منذ عام 2022، وهي طبيبة ذات مسيرة مهنية متميزة تجمع بين العمل الأكاديمي
                والخبرة الإكلينيكية في كل من المملكة العربية السعودية وجمهورية مصر العربية. وتشغل
                حاليًا أيضًا منصب أستاذ مساعد في كلية الطب – جامعة القاهرة۔
              </p>
              <p>
                من جامعة القاهرة (MBBCh) حصلت الدكتورة داليا على درجة البكالوريوس في الطب والجراحة
                عام 2007 بتقدير امتياز مع مرتبة الشرف، ثم أنهت سنة الامتياز في مستشفيات جامعة
                القاهرة عام 2008، وتبعها برنامج الإقامة الطبيه لمدة ثلاث سنوات في قسم النساء
                والتوليد بمستشفى قصر العيني – جامعة القاهرة. في عام 2012، حصلت على درجة الماجستير في
                أمراض النساء والتوليد،        وانضمت إلى الهيئة التدريسية كمعيدة. وفي عام 2018، نالت
                درجة الدكتوراه وتمت ترقيتها إلى أستاذ مساعد في يوليو 2025۔ ،(MD/PhD)
              </p>
              <p>
                منذ عام 2018، تخصصت الدكتورة داليا في علاج العقم وتقنيات أطفال الأنابيب، حيث عملت في
                وحدة الإخصاب بمستشفيات جامعة القاهرة، إلى جانب عدد من المراكز الرائدة في مصر في مجال
                الإخصاب المساعد. كما تُعد عضواً۔
              </p>
              <p>
                نشطاً في هيئة التدريس لدبلوم أطفال الأنابيب بجامعة القاهرة، وشاركت في العديد من
                الورش التدريبية المتخصصة في هذا المجال۔
              </p>{' '}
            </div>
          </div>
          ...
          <p>
            تحمل الدكتورة داليا الدبلوم الأمريكي في الإجراءات التجميلية النسائية، كما حصلت على
            شهادات متخصصة في التنظير الرحمي التشخيصي والعلاجي. وأتمّت الجزء الأول من عضوية الكلية
            الملكية (MRCOG – Part 1) لأطباء النساء والولادة في المملكة المتحدة
          </p>{' '}
          <p>
            تعكس خبرتها الواسعة مزيجاً من التميّز الأكاديمي والرعاية الفردية، لا سيما في مجالات
            العقم المتقدم، وجراحة النساء، والصحة الشاملة للمرأة۔
          </p>
        </div>
      </div>
    </div>
