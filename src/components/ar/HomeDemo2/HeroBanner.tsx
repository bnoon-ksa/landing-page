...
function HeroBannerAr() {
  ...
  const slides = [
    {
      video: "https://bnoon.blob.core.windows.net/website/videos/ar-banner/2.mp4",
    ...
    {
      video: "https://bnoon.blob.core.windows.net/website/videos/ar-banner/4.mp4",
    ...
    {
      video: "https://bnoon.blob.core.windows.net/website/videos/ar-banner/5.mp4",
    ...
    {
      video: "https://bnoon.blob.core.windows.net/website/videos/ar-banner/7.mp4",
